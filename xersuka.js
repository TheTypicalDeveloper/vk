...
let user = new VK();
user.setOptions({
	token: 'f2bdfd1d99d4fbb1793ddd183bd5a4d0fabffa2124de63393fe4470fef3a46139cdc04776a3d658fc9e3d' // token ot страницы ( не обязательно )
});
let giving = false;
const cars = [
	{
...
vk.setOptions({ token: 'f2bdfd1d99d4fbb1793ddd183bd5a4d0fabffa2124de63393fe4470fef3a46139cdc04776a3d658fc9e3d', pollingGroupId:https:207840617 });
